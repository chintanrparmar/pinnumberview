...
public class PinNumberView extends AppCompatEditText {
    ...
    public PinNumberView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public PinNumberView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String repeated = new String(new char[mMaxLength]).replace("\0", "*");
        for (int i = 0; i < mNumChars; i++) {
            ...
            if (getText().length() > i) {
                ...
                canvas.drawText(repeated, i, i + 1, middle - textWidths[0] / 2, bottom - mLineSpacing, getPaint());
            }
